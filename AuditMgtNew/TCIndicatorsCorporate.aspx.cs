...
{
    public partial class TCIndicatorsCorporate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    lblLocation.Text = "TECOM Investments Corporate";
        ...
        public void OnConfirm(object sender, EventArgs e)
        {
            ...
            if (confirmValue == "Yes")
            {
                ...
                cmde.Parameters.Add("@locationid", SqlDbType.Int).Value = 19;
                ...
                //cmde.Parameters.Add("@sid", SqlDbType.Int).Value = exam.sid;
                cmdeu.Parameters.Add("@locationid", SqlDbType.Int).Value = 19;
                // cmde.Parameters.Add("@location", SqlDbType.NVarChar).Value = lblLocation.Text; ;
                //  cmde.Parameters.Add("@date", SqlDbType.DateTime).Value = DateTime.Today.ToString("dd/MM/yyyy");
                ...
                //cmde.Parameters.Add("@sid", SqlDbType.Int).Value = exam.sid;
                cmdstatus.Parameters.Add("@locationid", SqlDbType.Int).Value = 19;
