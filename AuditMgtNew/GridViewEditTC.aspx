<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewEditTC.aspx.cs" Inherits="AuditMgtNew.GridViewEditTC" %>
...
<asp:BoundField DataField="examid" HeaderText="examid" SortExpression="examid" Visible="False"></asp:BoundField>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                <SelectParameters>
                    <asp:QueryStringParameter DefaultValue="19" Name="locationid" 
                        QueryStringField="19" Type="Int32" />
