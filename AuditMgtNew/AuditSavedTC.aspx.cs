...
{
    public partial class AuditSavedTC : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Page.PreviousPage != null)
            {
                ...
                SavedExaminationTC exam = new SavedExaminationTC(Int32.Parse(Session["mid"].ToString()), Int32.Parse(sid), sname, location);
                exam.GetSavedQuestions();
                Session.Add("questionsSavedt", exam);
        ...
        public void DisplayQuestion()
        {
            ...
            SavedExaminationTC e = (SavedExaminationTC)Session["questionsSavedt"];
            // display data
        ...
        {
            SavedExaminationTC exam = (SavedExaminationTC)Session["questionsSavedt"];
