<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditLevelTC.aspx.cs" Inherits="AuditMgtNew.AuditLevelTC" %>
...
<body>
    ...
    <div id="header">
        <div class="logo"><asp:ImageButton ID="Image1" runat="server" Height="77px" 
            ImageUrl="~/Images/tecom_logo.png" Width="178px" onclick="Image1_Click" /></div>
        <ul>
