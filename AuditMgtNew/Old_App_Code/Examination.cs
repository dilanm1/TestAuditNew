...
public class Examination : Page
{
    public int SIZE;
        ...
        public Examination(int mid, int sid, String sname, String location)
        {
            this.mid = mid;
                ...
                default:
                    {
                        ...
                        SqlConnection con = new SqlConnection(DBUtil.ConnectionString);
                        SqlDataAdapter da = new SqlDataAdapter("select sid,qid,question,ref,guid from tblQuestionsJMSub where sid = " + sid, con);
                        DataSet ds = new DataSet();
                        da.Fill(ds, "questions");
                        int nquestions = ds.Tables[0].Rows.Count;
                        SIZE = nquestions;
