...
{
    public class ExaminationTC : Page
    {
        public int SIZE;
        public int mid;
        ...
        public ExaminationTC(int mid, int sid, String sname, String location)
        {
            this.mid = mid;
                ...
                case "TECOM Investments Corporate":
                    {
                        ...
                        SqlDataAdapter da = new SqlDataAdapter("select sid,qid,question,ref,guid from tblQuestionsTcomCorp where sid = " + sid, con);
                ...
                default:
                    {
                        ...
                        SqlConnection con = new SqlConnection(DBUtil.ConnectionString);
                        SqlDataAdapter da = new SqlDataAdapter("select sid,qid,question,ref,guid from tblQuestionsTComSBU where sid = " + sid, con);
                        DataSet ds = new DataSet();
                        da.Fill(ds, "questionst");
                        int nquestions = ds.Tables[0].Rows.Count;
                        SIZE = nquestions;
