<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrentAuditsDP.aspx.cs" Inherits="AuditMgtNew.Admin.CurrentAuditsDP" %>
...
<body>
    ...
    <center>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT * FROM [tbllocation2] WHERE ([verticalid] = @verticalid)">
            <SelectParameters>
