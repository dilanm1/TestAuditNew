<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBuildingDP.aspx.cs" Inherits="AuditMgtNew.Admin.EditBuildingDP" %>
...
<body>
    ...
    <div id="header">
     <div class="logo">   <asp:Image ID="Image1" runat="server" Height="77px" 
        ...
        <ul>
			...
			<li><a href="AdminDP.aspx">Admin</a></li>
    ...
    <div id="content">
        ...
        <asp:Label ID="Label1l" runat="server" Text="Edit Building Details"></asp:Label>
    ...
    <center>
         <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="600px" 
            ...
            <Fields>
                ...
                <asp:BoundField DataField="CEO" HeaderText="CEO" 
                    SortExpression="CEO" >
                </asp:BoundField>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [VerticalName], [Unit], [SubUnit], [Address], [Nature], [Sector], [Usage], [Number], [Square], [year], [Emp], [Visitors], [Guests], [Residents], [LeadAuditor], [Auditor1], [Auditor2], [Auditor3], [CEO], [COO], [DM], [DE], [Other], [id] FROM [tblBuilding] WHERE ([locationid] = @locationid)" 
