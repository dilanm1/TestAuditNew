...
{
    public partial class AddAuditLocationDP : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
          //  Button1.Text = "OK";
            ...
            TextBox123.Text = "Dubai Property Group Corporate";
        ...
        protected void BindBusinessNames()
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(DBUtil.ConnectionString);
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from SubVertical WHERE VerticalID= " + 2, con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
                con.Close();
                    ...
                    if (contentcheck.SelectedValue == "Add Corporate")
                    {
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                con7.Open();
                                SqlCommand cmd7 = new SqlCommand("select locationid from tbllocation where location ='" + "Dubai Property Group Corporate" + "'", con7);
                                ...
                                using (SqlConnection conn3 = new SqlConnection(DBUtil.ConnectionString))
                                {
                                    ...
                                    using (SqlCommand comm = new SqlCommand())
                                    {
                                        ...
                                        comm.Parameters.AddWithValue("@location", "Dubai Property Group Corporate");
                                        comm.Parameters.AddWithValue("@loc", locationid);
                                        comm.Parameters.AddWithValue("@vid", 2);
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AddAuditLocationDP.aspx");
        }
                    ...
                    if (contentcheck.SelectedValue == "SBU Audit")
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(DBUtil.ConnectionString))
                        {
                            ...
                            using (SqlCommand comm = new SqlCommand())
                            {
                                ...
                                comm.CommandType = CommandType.Text;
                                comm.CommandText = _query;
                                comm.Parameters.AddWithValue("@locid", 2);
                                comm.Parameters.AddWithValue("@vname", "Dubai Property Group Corporate");
