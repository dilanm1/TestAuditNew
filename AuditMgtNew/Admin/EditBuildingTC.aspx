<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBuildingTC.aspx.cs" Inherits="AuditMgtNew.Admin.EditBuildingTC" %>
...
<body>
    ...
    <div id="content">
        ...
        <asp:Label ID="Label1m" runat="server" Text="Edit Building Details"></asp:Label>        
