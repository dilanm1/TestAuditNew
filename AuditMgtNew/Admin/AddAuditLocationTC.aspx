<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAuditLocationTC.aspx.cs" Inherits="AuditMgtNew.AddAuditLocationTC" %>
...
<body>
    ...
    <div class="logo">    <asp:Image ID="Image1" runat="server" Height="97px" 
            ImageUrl="~/Images/tecom_logo.png" Width="200px" /> </div>
        <ul>
