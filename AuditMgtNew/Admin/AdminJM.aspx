<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminJM.aspx.cs" Inherits="AuditMgtNew.AdminJM" %>
    ...
    <div id="content">
      ...
      <div id="Div1"> 
       <ul style="width: 200px; height: 100px; table-layout: fixed;">
        <li><a href="ResetAuditProcessJM.aspx">Reset Audit Process</a></li>	
            <li><a href="ViewPreviousAudits.aspx">View Completed Audits</a></li>     
           <%--<li><a href="AssignRolesJM.aspx">Assign Roles</a></li>--%>
             <li><a href="EditQuestions.aspx">Edit Questions</a></li>                       	
			<li><a href="EditBuildingJM.aspx">Edit Location</a></li>	           
			<li><a href="AddAuditLocation.aspx">Add Location</a></li>		
		</ul>
