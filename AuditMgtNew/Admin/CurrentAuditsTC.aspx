<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrentAuditsTC.aspx.cs" Inherits="AuditMgtNew.Admin.CurrentAuditsTC" %>
...
<body>
    ...
    <center>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT * FROM [tbllocation2] WHERE ([verticalid] = @verticalid)">
            <SelectParameters>
