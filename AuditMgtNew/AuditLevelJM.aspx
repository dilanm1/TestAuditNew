<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditLevelJM.aspx.cs" Inherits="AuditMgtNew.AuditLevelJM" %>
...
<body>
    ...
    <div class="logo">    <asp:ImageButton ID="Image1" runat="server" Height="77px" 
            ImageUrl="~/Images/jumeirah_group_logo.png" Width="178px" OnClientClick="Image1_Click" /></div>
        <ul>
    ...
    <div id="content">
       <center>  
        <asp:table ID="tblLoginJM" runat="server" border="0" 
            ...
            <asp:TableRow>
            <asp:TableCell> <asp:CustomValidator runat="server" ID="cvmodulelist" ValidationGroup="Submit"
            ...
            <asp:TableCell HorizontalAlign="center">            
             <asp:ImageButton ID="ImageButton2" runat="server" ValidationGroup="Submit"  
