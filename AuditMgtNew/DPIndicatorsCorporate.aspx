<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DPIndicatorsCorporate.aspx.cs" Inherits="AuditMgtNew.DPIndicatorsCorporate" %>
...
<body>
    ...
    <asp:TableCell HorizontalAlign="left" Width="80%">
        <asp:Label ID="lblLocation" runat="server" Text="Dubai Property Group Corporate"></asp:Label>    
    </asp:TableCell>
   </asp:TableRow>
    <asp:TableRow>
     ...
     <asp:GridView ID="GridView1" runat="server" CssClass ="gv1"  Width="74%" BorderStyle="None"  HeaderStyle-BackColor="White"
        ...
        RowStyle-ForeColor="#3A3A3A" AutoGenerateColumns="false" PageSize="10" 
         ...
         <asp:BoundField DataField="status" HeaderText="id" />
          <asp:TemplateField>
          <ItemTemplate>
                 <asp:LinkButton ID="Button1" runat="server" Text="Edit" PostBackUrl='<%# "~/GridViewEditDP.aspx?RowIndex=" + Container.DataItemIndex %>'></asp:LinkButton>
            </ItemTemplate> 
         </asp:TemplateField>
         <asp:TemplateField>
          <ItemTemplate>
