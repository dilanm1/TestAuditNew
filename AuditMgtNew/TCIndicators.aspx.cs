...
{
    public partial class TCIndicators : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           // Session["location"] = null;
            if (!IsPostBack)
            {
                if ((Session["location"]) == null || (Session["location"].ToString()) == "TECOM Investments Corporate")
                {

             //   BindEmployeeDetails();
                    DropDownList1.Visible = true;
                    string query = ("SELECT tbllocation.location, tbllocation.locationid, tbllocation.verticalid FROM tblBuilding INNER JOIN tbllocation ON tblBuilding.locationid = tbllocation.locationid WHERE (tbllocation.verticalid = 3) AND tbllocation.locationid !=19 ");
        ...
        protected void BindEmployeeDetails()
        {
          ...
          //  Session["location"] = lblLocation.Text;
            ...
            ExaminationTC exam = (ExaminationTC)Session["questionst"];
