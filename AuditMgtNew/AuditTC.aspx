<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditTC.aspx.cs" Inherits="AuditMgtNew.AuditTC" %>
...
ErrorMessage="Please Enter Evidence." ControlToValidate="TextBox3" ForeColor="Red" ValidationGroup="Submit">
      ...
      <asp:table ID="tblButtons" runat="server" border="0" style="font-size: 100%; font-family: Verdana;" >
            <asp:TableRow Width="100%">
                ...
                <asp:TableCell Width="5%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="ImageButton1" runat="server" onclick="ImageButton1_ServerClick" ImageUrl="~/Images/glossary_button.png" Visible="True" /></asp:TableCell>
                 ...
                 <asp:TableCell Width="5%" HorizontalAlign="right" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="ImageButton8"  runat="server" onclick="ImageButton8_ServerClick" OnClientClick = "Confirm()" ImageUrl="~/Images/save_button.png"/></asp:TableCell>
               
                 <asp:TableCell Width="5%" HorizontalAlign="right" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="btnNext" ValidationGroup="Submit" runat="server" onclick="btnNext_ServerClick" ImageUrl="~/Images/savenext_button.png" /><asp:ImageButton ID="ImageButton2" runat="server" Visible="false" onclick="ImageButton2_ServerClick" ImageUrl="~/Images/viewreport_button.png" /></asp:TableCell>
            </asp:TableRow>
    ...
    <br />
     <script type = "text/javascript">
         function Confirm() {
             ...
             if (confirm("Audit will be Saved!! OR Press 'Cancel' to carry on the Audit")) {
