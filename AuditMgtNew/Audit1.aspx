<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Audit1.aspx.cs" Inherits="AuditMgtNew.Audit1" %>
...
<asp:TableCell VerticalAlign="Top">
    ...
    <asp:ListItem Text="Within 6 month" Value="Within 6 month"></asp:ListItem>
        ...
        ControlToValidate="RadioButtonList1" ForeColor="Red" ValidationGroup="Submit"></asp:RequiredFieldValidator>
</asp:TableCell>
            </asp:TableRow>
    </asp:table>
      ...
      <asp:table ID="tblButtons" runat="server" border="0" style="font-size: 100%; font-family: Verdana;" >
            <asp:TableRow Width="100%">
                ...
                <%-- <asp:TableCell Width="5%" HorizontalAlign="right" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="ImageButton9" runat="server" onclick="ImageButton9_ServerClick" ImageUrl="~/Images/previous_button.png" /></asp:TableCell>--%>
                 <asp:TableCell Width="5%" HorizontalAlign="right" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="btnNext" runat="server" onclick="btnNext_ServerClick" ValidationGroup="Submit" ImageUrl="~/Images/savenext_button.png" /><asp:ImageButton ID="ImageButton2" runat="server" Visible="false" onclick="ImageButton2_ServerClick" ImageUrl="~/Images/viewreport_button.png" /></asp:TableCell>
            </asp:TableRow>
