...
{
    public partial class ReportAuditorJMIncomplete : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Customers dsCustomers = GetData("select * from View_Answers_Building_2  where mid=@mid and location=@location and auditid IS NULL Order By View_Answers_Building_2.id asc ");
        ...
        //        SqlCommand cmd = new SqlCommand("select * from tbllocation ", con);
        //        SqlDataAdapter da = new SqlDataAdapter(cmd);
