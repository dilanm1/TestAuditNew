<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewEditDP.aspx.cs" Inherits="AuditMgtNew.GridViewEditDP" %>
...
<body>
   ...
   <br />  
        <asp:Label ID="lblsid" runat="server" Text="Please Select an Indicator:" Visible="true"></asp:Label><asp:DropDownList
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT [sid], [sname] FROM [oe_subjects] ORDER BY [sid], [sname]">
        </asp:SqlDataSource>
        <br />
