<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewEditTCSub.aspx.cs" Inherits="AuditMgtNew.GridViewEditTCSub" %>
...
<body>
    ...
    <asp:Label ID="lblLocationd" runat="server" Text="Please select a Location:"></asp:Label> 
  ...
  <asp:ListItem Value="">Select</asp:ListItem>
    ...
    <br />
     <asp:Label ID="Label1321" runat="server" Text="Please Select The Indicator:" Visible="True"></asp:Label>
        <asp:DropDownList
...
<asp:BoundField DataField="examid" HeaderText="examid" SortExpression="examid" Visible="False"></asp:BoundField>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="SELECT * FROM [tblSavedAnswers] WHERE (([locationid] = @locationid)  AND ([sid] = @sid) AND ([mid] = @mid))" 
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="ddlCountries" Name="locationid" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:examConnectionString %>" 
                 ...
                 SelectCommand="SELECT [locationid], [location] FROM [tbllocation] WHERE ([verticalid] = @verticalid) AND ([locationid] != 19)">
            <SelectParameters>
