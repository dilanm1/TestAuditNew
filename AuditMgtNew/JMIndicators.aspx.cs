...
{
    public partial class JMIndicators : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if ((Session["location"]) == null || (Session["location"].ToString()) =="Jumeirah Group Corporate")
                {

                    DropDownList1.Visible = true;
                    string query = ("SELECT tbllocation.location, tbllocation.locationid, tbllocation.verticalid FROM tblBuilding INNER JOIN tbllocation ON tblBuilding.locationid = tbllocation.locationid WHERE (tbllocation.verticalid = 1) AND tbllocation.locationid !=1 ");
                ...
                if ((Session["location"]) != null || (Session["location"].ToString()) !="Jumeirah Group Corporate")
                {
                   ...
                   // DropDownList1.SelectedItem.Text = context;
            ...
            if (DropDownList1.Items.Count > 1 && DropDownList1.SelectedItem.Text == "Select")
            {
                //lblLocation.Visible = false;
                GridView1.Enabled = false;
                GridView1.Visible = false;
                lblLocation.Text = "Please Select Location To Start An Audit!!";
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                lblLocation.Text = DropDownList1.SelectedItem.Text;
                lblLocation.Visible = true;
                lblLocation.ForeColor = System.Drawing.Color.Black;
        ...
        protected void BindEmployeeDetails()
        {
           ...
           // Session["location"] = lblLocation.Text;
            ...
            string name = Session["location"].ToString();
            ...
            //string commandQuery = ("SELECT oe_subjects.sid, oe_subjects.sname, oe_subjects_status.mid, oe_subjects_status.location, oe_subjects_status.status, oe_subjects_status.score FROM oe_subjects left outer JOIN oe_subjects_status ON oe_subjects.sid = oe_subjects_status.sid and oe_subjects_status.location ='" + DropDownList1.SelectedItem.Text + "' and oe_subjects_status.mid =@mid");
            string commandQuery = ("SELECT oe_subjects.sid, oe_subjects.sname, oe_subjects_status.mid, oe_subjects_status.location, oe_subjects_status.status, oe_subjects_status.score FROM oe_subjects left outer JOIN oe_subjects_status ON oe_subjects.sid = oe_subjects_status.sid and oe_subjects_status.location ='" + name + "' and oe_subjects_status.mid =@mid");
            //string commandQuery = ("SELECT oe_subjects.sid, oe_subjects.sname, oe_subjects_status.mid, oe_subjects_status.location, oe_subjects_status.status, oe_subjects_status.score FROM oe_subjects left outer JOIN oe_subjects_status ON oe_subjects.sid = oe_subjects_status.sid and oe_subjects_status.location =@loc and oe_subjects_status.mid =@mid");
            using (SqlCommand cmd = new SqlCommand(commandQuery, con))
            {
              ...
              //  cmd.Parameters.AddWithValue("@loc", Session["location"]);
        ...
        protected void BindEmployeeDetails2()
        {
            ...
            Examination exam = (Examination)Session["questions"];
            //  string name = lblLocation.Text.ToString();
            string name = Session["location2"].ToString();
            SqlConnection con = new SqlConnection(DBUtil.ConnectionString);
            //string color_na = textBox3.Text;
            // string commandQuery = "select oe_subjects.sid, oe_subjects.sname, oe_subjects.status, oe_subjects.score FROM oe_subjects INNER JOIN tbllocation ON oe_subjects.locationid = tbllocation.locationid where tbllocation.location=@loc and tbllocation.mid=@mid";
            string commandQuery = ("SELECT oe_subjects.sid, oe_subjects.sname, oe_subjects_status.mid, oe_subjects_status.location, oe_subjects_status.status, oe_subjects_status.score FROM oe_subjects left outer JOIN oe_subjects_status ON oe_subjects.sid = oe_subjects_status.sid and oe_subjects_status.location ='" + name + "' and oe_subjects_status.mid =@mid");
        ...
        public void OnConfirm(object sender, EventArgs e)
        {
            ...
            if (confirmValue == "Yes")
            {
                ...
                cmde.CommandText = ("select locationid from tbllocation where location ='" + lblLocation.Text + "'");
                ...
                cmde.Parameters.Add("@locationid", SqlDbType.NVarChar).Value = locationid2;
                ...
                // int examid2 = (Int32)cmde.ExecuteScalar();
                cmde.CommandText = ("select locationid from tbllocation where location ='" + lblLocation.Text + "'");
                int locationid3 = (Int32)cmde.ExecuteScalar();
                ...
                //cmde.Parameters.Add("@sid", SqlDbType.Int).Value = exam.sid;
                cmdeu.Parameters.Add("@locationid", SqlDbType.NVarChar).Value = locationid3;
                // cmde.Parameters.Add("@location", SqlDbType.NVarChar).Value = lblLocation.Text; ;
                //  cmde.Parameters.Add("@date", SqlDbType.DateTime).Value = DateTime.Today.ToString("dd/MM/yyyy");
                ...
                cmde.CommandText = ("select locationid from tbllocation where location ='" + lblLocation.Text + "'");
                int locationid4 = (Int32)cmde.ExecuteScalar();
                ...
                //cmde.Parameters.Add("@sid", SqlDbType.Int).Value = exam.sid;
                cmdstatus.Parameters.Add("@locationid", SqlDbType.NVarChar).Value = locationid4;
