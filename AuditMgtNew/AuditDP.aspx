<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditDP.aspx.cs" Inherits="AuditMgtNew.AuditDP" %>
...
<body onload="changeHashOnLoad();">
    ...
    <div class="logo">    <asp:Image ID="Image1" runat="server" Height="77px" 
        ...
        <ul>
			<asp:Button ID="btnlogout" runat="server" Text="logout" BackColor="White" 
