<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSavedTC.aspx.cs" Inherits="AuditMgtNew.AuditSavedTC" %>
    ...
    <asp:ListItem Text="Within 6 month" Value="Within 6 month"></asp:ListItem>
      ...
      <asp:table ID="tblButtons" runat="server" border="0" style="font-size: 100%; font-family: Verdana;" >
            <asp:TableRow Width="100%">
                ...
                <asp:TableCell Width="5%" HorizontalAlign="Left" style="font-weight:normal; color: #878787; background-color: " Font-Size="Small"><asp:ImageButton ID="ImageButton1" runat="server" onclick ="ImageButton1_ServerClick" ImageUrl="~/Images/glossary_button.png" /></asp:TableCell>
