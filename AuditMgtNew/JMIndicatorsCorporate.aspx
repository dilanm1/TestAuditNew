<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JMIndicatorsCorporate.aspx.cs" Inherits="AuditMgtNew.JMIndicatorsCorporate" %>
...
<body>
    ...
    <asp:TableCell HorizontalAlign="left" Width="80%">
        <asp:Label ID="lblLocation" runat="server" Text="Jumeirah Group Corporate"></asp:Label>    
    </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
    ...
    <br />
     <asp:GridView ID="GridView1" runat="server" CssClass ="gv1"  Width="74%" BorderStyle="None"  HeaderStyle-BackColor="White"
        ...
        RowStyle-ForeColor="#3A3A3A" AutoGenerateColumns="false" PageSize="10" 
            ...
            onrowdatabound="GridView1_RowDataBound1"  ShowFooter="true" DataKeyNames="sid,sname">  
