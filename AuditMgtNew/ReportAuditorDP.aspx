<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportAuditorDP.aspx.cs" Inherits="AuditMgtNew.ReportAuditorDP" %>
...
<body>
    ...
    <asp:Label ID="LabelL" runat="server" Text="Select Location:" Font-Size="Small"></asp:Label>
