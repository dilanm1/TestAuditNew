<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewEditJMSub.aspx.cs" Inherits="AuditMgtNew.GridViewEditJMSub" %>
...
<body>
  ...
  <asp:ListItem Value="">Select</asp:ListItem>
    ...
    <br />
     <asp:Label ID="Label1238l" runat="server" Text="Please Select The Indicator:" Visible="True"></asp:Label>
        <asp:DropDownList
...
<asp:BoundField DataField="examid" HeaderText="examid" SortExpression="examid" Visible="False"></asp:BoundField>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [locationid], [location] FROM [tbllocation] WHERE ([verticalid] = @verticalid) AND ([locationid] != 1)">
            <SelectParameters>
