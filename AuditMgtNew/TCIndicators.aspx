<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TCIndicators.aspx.cs" Inherits="AuditMgtNew.TCIndicators" %>
    ...
    <asp:GridView ID="GridView1" runat="server"  CssClass ="gv1"  Width="80%" BorderStyle="None"  HeaderStyle-BackColor="White"
        ...
        <Columns>
         ...
         <asp:BoundField DataField="status" HeaderText="id" />
          <asp:TemplateField>
          <ItemTemplate>
                 <asp:LinkButton ID="Button1" runat="server" Text="Edit" PostBackUrl='<%# "~/GridViewEditTCSub.aspx?RowIndex=" + Container.DataItemIndex %>'></asp:LinkButton>
            </ItemTemplate> 
         </asp:TemplateField>
         <asp:TemplateField>
          <ItemTemplate>
        ...
        <asp:Button ID="btnConfirm" runat="server" OnClick = "OnConfirm" 
            Text = "Save Audit" OnClientClick = "Confirm()" Height="26px" Visible="False"/>
    </center>
