...
{
    public partial class AuditSaved : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)        
        {
            ...
            if (this.Page.PreviousPage != null)
            {
              ...
              //  id = row.Cells[2].Text;
                ...
                SavedExamination exam = new SavedExamination(Int32.Parse(Session["mid"].ToString()), Int32.Parse(sid), sname, location);
                exam.GetSavedQuestions();
                Session.Add("questionsSaved", exam);
        ...
        public void DisplayQuestion()
        {
            ...
            SavedExamination e = (SavedExamination)Session["questionsSaved"];
            // display data
            ...
            //DropDownList1.SelectedItem.Text = q.action;
            //if (q.action!= "0")
            //{
            //    DropDownList1.Text = q.action;
            //}
            //else if (q.action == "0")
            //{
        ...
        {
            SavedExamination exam = (SavedExamination)Session["questionsSaved"];
        ...
        protected void btnNext_ServerClick(object sender, EventArgs e)
        {
            ...
            // Response.Redirect("showresult.aspx");
            {
             ...
             //   cmda.Parameters.Add("@status", SqlDbType.NVarChar).Value = "complete";
             //   cmda.Parameters.Add("@score", SqlDbType.Float).Value = exam.score;
             //   cmda.Parameters.Add("@date", SqlDbType.DateTime).Value = DateTime.Today.ToString("dd/MM/yyyy");
             //   cmda.ExecuteNonQuery();
